...
const Hero = () => {
  return (
    <div className='relative w-full h-full bg-gradient-to-r from-blue-700 to-blue-800  p-15 flex flex-col justify-center items-center gap-5 text-white'>
        <h2 className='text-center text-7xl font-semibold'>Your Perfect Beach Day,<br /><span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400'>Predicted!</span></h2>
        ...
        <div className='text-center relative'>
            ...
            <button className='bg-orange-600 absolute left-125 right-0 top-1 w-24 h-10 rounded-xl'>Search</button>
        </div>
